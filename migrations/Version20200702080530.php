 ...
 */
final class Version20200702080530 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE task (id INT AUTO_INCREMENT NOT NULL, date_id INT DEFAULT NULL, user_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, unit VARCHAR(50) NOT NULL, validate TINYINT(1) NOT NULL, INDEX IDX_527EDB25A76ED395 (user_id), INDEX IDX_527EDB25B897366B (date_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, level_id INT DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, image VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, agora_number VARCHAR(8) NOT NULL, nb_resident INT NOT NULL, living_area DOUBLE PRECISION NOT NULL, gas TINYINT(1) NOT NULL, insulation TINYINT(1) NOT NULL, nif_number VARCHAR(30) NOT NULL, gas_average_consumption DOUBLE PRECISION NOT NULL, water_average_consumption DOUBLE PRECISION NOT NULL, electricity_average_consumption DOUBLE PRECISION NOT NULL, waste_average_consumption DOUBLE PRECISION NOT NULL, registration_date DATE NOT NULL, navigo_number VARCHAR(8) DEFAULT NULL, saving_water DOUBLE PRECISION NOT NULL, saving_transport DOUBLE PRECISION NOT NULL, saving_electricity DOUBLE PRECISION NOT NULL, saving_gas DOUBLE PRECISION NOT NULL, saving_waste DOUBLE PRECISION NOT NULL, INDEX IDX_8D93D6495FB14BA7 (level_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
